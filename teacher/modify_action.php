...
<?php
  ...
  //
	$updatesql = "update wx_article set title = '$title',author = '$author',picture = '$picture',description = '$description',content = '$content',dateline=$dateline where id=$id";
	// echo $insertsql;die();
  $query= $mysqli->query($updatesql);
  // echo $query;die();
	if($query) {
		echo '<div class="page msg_success js_show">
          <div class="weui-msg">
              ...
              <div class="weui-msg__text-area">
                  <h2 class="weui-msg__title">修改文章成功</h2>
              </div>
              <div class="weui-msg__opr-area">
                  <p class="weui-btn-area">
                      <a href="article.php?id='.$id.'" class="weui-btn weui-btn_primary">查看</a>
                      <a href="manage.php" class="weui-btn weui-btn_default">返回</a>
                  </p>
              </div>
          </div>
      </div>';
		...
		echo '<div class="page">
          <div class="weui-msg">
              <div class="weui-msg__icon-area"><i class="weui-icon-warn weui-icon_msg"></i></div>
              <div class="weui-msg__text-area">
                  <h2 class="weui-msg__title">修改文章失败</h2>
              </div>
              <div class="weui-msg__opr-area">
                  <p class="weui-btn-area">
                      <a href="javascript:history.back();" class="weui-btn weui-btn_default">返回</a>
