...
if(isset($_SESSION['username'])){
  ...
  if($_SESSION['identity']==2){
		$sql = "select * from wx_comment where answer='管理员'";
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              <div class="list-group">
                ...
                <a href="manage_apply.php" class="list-group-item active">管理申请</a>
                ...
                <tbody>
                  ...
                  ?>
                        <tr>
                          ...
                          <td><a href="reply_delete.php?id=<?php echo $value['id'];?>">删除</a>
                          </td>
                        </tr>
                  <?php
                      }
