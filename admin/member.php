        ...
        <div class="col-md-2">
          <div class="panel panel-default">
            ...
            <div class="list-group">
              ...
              <a href="member.php" class="list-group-item active">用户管理</a>
              <a href="manage_apply.php" class="list-group-item">管理申请</a>
        ...
        <div class="col-md-10">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <p><a href="member_add.php" class="btn btn-primary" role="button">添加</a></p>
                ...
                <tbody>
                  ...
                  ?>
                        <tr>
                          ...
                          <td>
                            <form class="" action="member_modify.php?id=<?php echo $value['id'];?>" method="post">
                          ...
                          <td><a href="member_delete.php?id=<?php echo $value['id'];?>">删除</a>
                          </td>
                        </tr>
                  <?php
                      }
