		...
		<div class="body-container">
			<div class="row">
              ...
              <div class="list-group">
                ...
                <a href="member.php" class="list-group-item">用户管理</a>
					...
					<div class="col-md-10">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form method="post" action="add_action.php" class="form-horizontal" enctype="multipart/form-data">
								    ...
								    <input type="file" name="file" id="exampleInputFile" style="padding-left:6px;">
								  </div>
