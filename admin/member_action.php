...
<?php
  ...
  $sql = "SELECT username FROM wx_user WHERE username = '".$username."' and telephone = '".$telephone."'";
  // echo $sql;die();
  $result = mysqli_fetch_row($mysqli->query($sql))[0];
	if(!$result) {
    ...
    $query= $mysqli->query($insertsql);
		echo '<div class="page msg_success js_show">
          <div class="weui-msg">
              ...
              <div class="weui-msg__text-area">
                  <h2 class="weui-msg__title">创建用户成功</h2>
              </div>
		...
		echo '<div class="page">
          <div class="weui-msg">
              ...
              <div class="weui-msg__text-area">
                  <h2 class="weui-msg__title">用户已存在,添加失败</h2>
              </div>
              <div class="weui-msg__opr-area">
                  <p class="weui-btn-area">
                      <a href="javascript:history.back();" class="weui-btn weui-btn_primary">返回</a>
